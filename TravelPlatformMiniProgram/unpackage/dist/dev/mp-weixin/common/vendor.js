...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__11FC83E",
    appName: "TravelPlatformMiniProgram",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.110.186,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_YL_ovc";
...
const tabBar = {
  ...
  list: [
    ...
    {
      pagePath: "pages/spots/spots",
      text: "景点",
      iconPath: "static/tabbar/spots.png",
      selectedIconPath: "static/tabbar/spots-active.png"
    },
    {
